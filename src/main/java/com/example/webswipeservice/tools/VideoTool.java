...
public class VideoTool {
     ...
     * @return 视频的url
     */
    public static String downloadVideoFromQly(String domain, boolean useHttps, String key, long expireInSeconds, String accessKey, String secretKey) throws QiniuException {
